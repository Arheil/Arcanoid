...
// каждый ряд состоит из 14 кирпичей. На уровне будут 6 пустых рядов,
// а затем 8 рядов с кирпичами 
...
// делаем зазор 2px между кирпичами
const brickGap = 2;
// размеры кирпича
const brickWidth = 25;
...
// у нас 14 кирпичей по 25px и 13 промежутков по 2px, а общая ширина холста 400px
//получаем общую ширину стен: 400 - (14 * 25 + 2 * 13) = 24px
// разделим пополам, чтобы получить ширину каждой стены = 12px
const wallSize = 12;

// основной массиы для игры
const bricks = [];
...
document.addEventListener('keydown', function (e) {
	...
	// обрабатываем нажатие на пробел (запускаем шарик)
